...
const sections = [
  {
  image: "/images/webp/still-life-cosmetic-products.webp", // Replace with your actual image path
  ...
  {
  image: "/images/webp/pexels-shvetsa-5760898.webp", // Replace with your actual image path
      ...
      {sections.map((section, idx) => (
        ...
        >
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center items-start px-6 md:px-12 py-8 md:py-0 bg-white/90" style={{fontFamily: 'var(--font-sans, Inter, Arial, sans-serif)'}}>
            ...
            <Link href="/philosophy" className="bg-black text-white px-6 py-2 rounded shadow hover:bg-white hover:text-black transition font-medium text-center block cursor-pointer ring-1 ring-black/10 hover:ring-2 hover:ring-black">{section.button}</Link>
          </div>
        </div>
      ))}
    </section>
