...
export default function NewsletterSignup() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl mx-auto p-8 sm:p-10 md:p-12 text-center">
        ...
        <AnimatedSection animation="fadeIn" delay={0.4}>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light mb-4 sm:mb-5 text-white tracking-wide" style={{ fontFamily: 'Oswald, sans-serif' }}>
            Join the SBK Fragrances Family
          </h2>
        </AnimatedSection>

        <AnimatedSection animation="fadeIn" delay={0.6}>
          <p className="mb-6 sm:mb-8 text-white/90 text-base sm:text-lg leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif' }}>
            Sign up for our newsletter and get <span className="font-medium text-white">exclusive offers</span>, fragrance tips, and early access to new arrivals
          </p>
        </AnimatedSection>

        {submitted ? (
            <AnimatedSection animation="scale" delay={0.2}>
            <p className="text-green-300 font-light text-lg sm:text-xl tracking-wide" style={{ fontFamily: 'Montserrat, sans-serif' }}>
