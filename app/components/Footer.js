        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-10 pb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-2.5 text-sm text-gray-600">
              <li><a href="/shop" className="hover:text-gray-900 transition-colors">Shop All</a></li>
              <li><a href="/collections" className="hover:text-gray-900 transition-colors">Collections</a></li>
              <li><a href="/bestsellers" className="hover:text-gray-900 transition-colors">Best Sellers</a></li>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:info@sbkfragrances.com" className="hover:text-gray-900 transition-colors">info@sbkfragrances.com</a>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                  </svg>
                  <a href="tel:+15551234567" className="hover:text-gray-900 transition-colors">+1 (555) 123-4567</a>
                </div>
