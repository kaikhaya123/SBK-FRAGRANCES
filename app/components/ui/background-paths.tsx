...
// When `button.tsx` is compiled as loose JS for the build, TypeScript
// can lose accurate prop typings for the forwarded ref. Use a JSDoc cast
// so we avoid TypeScript-only `as` expressions that Babel/Turbopack cannot
// parse during the build.
...
export function BackgroundPaths({ title = "Background Paths" }) {
    ...
    return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white" style={{ backgroundColor: '#ffffff' }}>
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    <div className="inline-block group relative bg-gradient-to-b from-white/10 to-white/10 dark:from-white/10 dark:to-black/10 p-px rounded-2xl backdrop-blur-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <button
                            type="button"
